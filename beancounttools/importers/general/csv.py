...
class Importer(identifier.IdentifyMixin, InstitutionMixin, CSVImporter):
    """Importer for CSV files."""

    def __init__(self, config, account, currency, regexps,
                 skip_lines: int = 0,
                 last4_map: typing.Optional[typing.Dict] = None,
                 categorizer: typing.Optional[typing.Callable] = None,
                 institution: typing.Optional[str] = None,
                 debug: bool = False,
                 dateutil_parse: typing.Optional[typing.Dict] = None,
                 csv_dialect: typing.Union[str, python_csv.Dialect] = 'excel',
        ...
        transactions = {
            ...
            P.Transaction.NARRATION: (
                ...
                [fieldname for enumval, fieldname in config.items()
                 if enumval in
                 (Col.NARRATION1, Col.NARRATION2, Col.NARRATION3)]
            ),
